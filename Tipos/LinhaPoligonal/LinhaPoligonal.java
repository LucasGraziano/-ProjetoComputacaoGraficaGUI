...
/**
 * Classe da Linha Poligonal Matematica
 */
public class LinhaPoligonal {
     ...
     */
    public LinhaPoligonal(double x1, double y1, double x2, double y2) {
     ...
     * @param p2 -  ponto 2
     */
    public LinhaPoligonal(Ponto p1, Ponto p2) {
        setP1(p1);
        setP2(p2);
     ...
     * @param r - reta
     */
    public LinhaPoligonal (LinhaPoligonal r){
        setP1(r.getP1());
        setP2(r.getP2());
    }
